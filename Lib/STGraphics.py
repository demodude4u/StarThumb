# Modified version of thumbyGrayscale.py
# - Changed from 2-bit VLSB to 8-bit indexed (vertical addressed)
...
_WIDTH = const(72)
_HEIGHT = const(40)
_IBUFF_SIZE = const(_WIDTH * _HEIGHT)
_SFBUFF_SIZE = const((_HEIGHT // 8) * _WIDTH)
_SFBUFF_INT_SIZE = const(_SFBUFF_SIZE // 4)
...
class Grayscale:
    ...
    def __init__(self):
        ...
        self.buffer = bytearray(_IBUFF_SIZE)

        self._subframes = array('O', [bytearray(_SFBUFF_SIZE),
                                      bytearray(_SFBUFF_SIZE), bytearray(_SFBUFF_SIZE)])
    ...
    def init_display(self):
        ...
        self._spi.write(bytearray([
            0xae, 0x20, 0x01, 0x40, 0xa1, 0xa8, 39, 0xc8, 0xd3, 0, 0xda, 0x12,
